...
public class AppointmentAdherenceStrategy : IAdherenceCalculator
{
    private const decimal AlertThreshold = 80m;
    private const decimal CriticalThreshold = 60m;

    public ComplianceCategory Category => ComplianceCategory.Appointment;
